...
<div class="flex justify-center gap-4 p-8">
    ...
    <button v-for="page in pages" :key="page" class="rounded-md bg-slate-200 p-2 font-medium text-slate-600 shadow-md" :class="page === activePage ? 'bg-blue-300 text-slate-100': ''"> {{ page }}</button>
